        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="card">
                    ...
                    @endif
                    <form id="myform" action="{{route('invoices.edit', $invoice->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    <h6 class="mb-0"><b>Start Date :</b> <input type="date" class="form-control" name="start_date" data-date-format="DD/MM/YYYY" value="{{\Carbon\Carbon::parse($invoice->service_date)->toDateString()}}"></h6>
                                </div>

                            <div class="col-md-12">
                                <h6 class="mb-0"><b>Charge To :</b> <input type="text" class="form-control" name="charge_to" value="{{$invoice->name}}" placeholder="eg: James Jord"></h6>
                                <h6 class="mb-0"><b>Send Invoice To :</b> <input type="email" value="{{$invoice->send_to}}" class="form-control" name="send_to" placeholder="eg:abdulrehmankhan0072@gmail.com"></h6>
                                <h6 class="mb-0"><b>Send Invoice Copy :</b> <input value="{{$invoice->cc != 'no cc' ? $invoice->cc : ''}}" type="email" class="form-control" name="send_copy_to" placeholder="eg:abdulrehmankhan0081@gmail.com"></h6>
                                <h6 class="mb-0"><b>Invoice No :</b> <input type="text" class="form-control" name="invoice_no" value="{{$invoice->uniqId}}" readonly></h6>
                                <h6 class="mb-0"><b>Payment Method :</b> <select class="form-control paymentmethod" name="payment_method">
                                        <option value="">Select Payment Method</option>
                                        <option value="Venmo" {{$invoice->payment_method == 'Venmo' ? 'selected' : ''}}>Venmo</option>
                                        <option value="CreditCard" {{$invoice->payment_method == 'CreditCard' ? 'selected' : ''}}>Credit Card</option>
                                        <option value="Paypal" {{$invoice->payment_method == 'Paypal' ? 'selected' : ''}}>Paypal</option>
                                        <option value="Zelle" {{$invoice->payment_method == 'Zelle' ? 'selected' : ''}}>Zelle</option>
                                ...
                                <div class="table-responsive project-invoice">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody class="appendData">
                                            @include('dashboard.invoices.component.items')
                                        </tbody>
                                        <tfoot>
                                        <tr>
