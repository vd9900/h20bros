            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    @if($errors->any())
                        {{ implode('', $errors->all()) }}
                    @endif
                    <form id="location-form-create" action="{{route('service-areas.create')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset class="mb-5">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name" aria-describedby="nameHelp" list="cars" value="{{ old('name') }}" >
                                            <datalist id="cars">
